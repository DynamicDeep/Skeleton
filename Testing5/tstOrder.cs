...
namespace Testing5
{
    ...
    public class tstOrder
    {
        ...
        public void CustomerIdMaxLessOne()
        {
            ...
            String Error = "";
            //create some test data to pass to the method
            string CustomerId = "999998"; //this should be ok
                                    //invoke the method
            Error = AnOrder.Valid(CustomerId, TotalCost, Address, DeliveryDate);
            //test to see that the result is correct
            Assert.AreEqual(Error, "");
        ...
        public void CustomerMid()
        {
            ...
            String Error = "";
            //create some test data to pass to the method
            string CustomerId = "500000"; //this should be ok
            //invoke the method
            Error = AnOrder.Valid(CustomerId, TotalCost, Address, DeliveryDate);
            //test to see that the result is correct
            Assert.AreNotEqual(Error, "");
        ...
        public void CustomerIdMaxPlusOne()
        {
            ...
            String Error = "";
            //create some test data to pass to the method
            string CustomerId = "1000000"; //this should be ok
                                    //invoke the method
            //invoke the method
            Error = AnOrder.Valid(CustomerId, TotalCost, Address, DeliveryDate);
            //test to see that the result is correct
